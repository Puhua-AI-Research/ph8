package com.puhua.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${puhua.websocket.sender-rocketmq.topic}",
        consumerGroup = "${puhua.websocket.sender-rocketmq.consumer-group}",
