package com.puhua.framework.ratelimiter.config;

import com.puhua.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.puhua.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.puhua.framework.ratelimiter.core.keyresolver.impl.*;
...
public class PuhuaRateLimiterConfiguration {
