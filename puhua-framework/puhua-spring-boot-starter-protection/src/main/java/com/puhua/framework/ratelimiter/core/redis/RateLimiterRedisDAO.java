package com.puhua.framework.ratelimiter.core.redis;
...
public class RateLimiterRedisDAO {
    ...
    public Boolean tryAcquire(String key, int count, int time, TimeUnit timeUnit,long permits) {
        // 1. 获得 RRateLimiter，并设置 rate 速率
        RRateLimiter rateLimiter = getRRateLimiter(key, count, time, timeUnit);
        // 2. 尝试获取 permits
