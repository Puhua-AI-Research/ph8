...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.puhua.api";
    private static final String ARTIFACT_ID = "puhua";
    private static final String PACKAGE_NAME = "com.puhua";
    private static final String TITLE = "普华API开放平台运营系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.puhua.api";
        String artifactIdNew = "puhua";
        String packageNameNew = "com.puhua";
        String titleNew = "普华API开放平台运营系统";
        String projectBaseDirNew = "/Users/zhangyi/IdeaProjects/ph8-api-parent"; // 一键改名后，“新”项目所在的目录
