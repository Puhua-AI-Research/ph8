package com.puhua.gateway.handler;
 ...
 *
 * 在功能上，和 puhua-spring-boot-starter-web 的 GlobalExceptionHandler 类是一致的
 *
 * @author 中航普华
 */
@Component
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    private CommonResult<?> responseStatusExceptionHandler(ServerWebExchange exchange,
        ...
        // TODO 中航普华：这里要精细化翻译，默认返回用户是看不懂的
