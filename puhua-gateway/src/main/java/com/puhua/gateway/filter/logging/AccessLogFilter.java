package com.puhua.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import com.puhua.framework.common.util.json.JsonUtils;
import com.puhua.gateway.util.SecurityFrameworkUtils;
import com.puhua.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 puhua-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
 * TODO 中航普华：如果网关执行异常，不会记录访问日志，后续研究下 https://github.com/Silvmike/webflux-demo/blob/master/tests/src/test/java/ru/hardcoders/demo/webflux/web_handler/filters/logging
 *
 * @author 中航普华
 */
@Slf4j
