package com.puhua.module.infra.service.codegen.inner;
...
import com.puhua.framework.apilog.core.enums.OperateTypeEnum;
import com.puhua.framework.common.exception.util.ServiceExceptionUtil;
...
import com.puhua.framework.common.util.string.StrUtils;
...
import com.puhua.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "puhua-module-${table.moduleName}/" + // 顶级模块
                "puhua-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "puhua-module-${table.moduleName}/" + // 顶级模块
                "puhua-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "puhua-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "puhua-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
