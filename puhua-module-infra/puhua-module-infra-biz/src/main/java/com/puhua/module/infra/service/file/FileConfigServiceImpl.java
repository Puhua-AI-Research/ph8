...
import com.puhua.module.infra.convert.file.FileConfigConvert;
import com.puhua.module.infra.dal.dataobject.file.FileConfigDO;
import com.puhua.module.infra.dal.mysql.file.FileConfigMapper;
...
import com.puhua.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.puhua.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.puhua.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.puhua.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public String testFileConfig(Long id) throws Exception {
        ...
        validateFileConfigExists(id);
        // 上传文件
        byte[] content = ResourceUtil.readBytes("file/dog.jpg");
