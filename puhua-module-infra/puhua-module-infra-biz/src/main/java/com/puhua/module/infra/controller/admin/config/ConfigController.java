package com.puhua.module.infra.controller.admin.config;
...
import com.puhua.module.infra.convert.config.ConfigConvert;
import com.puhua.module.infra.dal.dataobject.config.ConfigDO;
import com.puhua.module.infra.enums.ErrorCodeConstants;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "puhua.biz.username")
