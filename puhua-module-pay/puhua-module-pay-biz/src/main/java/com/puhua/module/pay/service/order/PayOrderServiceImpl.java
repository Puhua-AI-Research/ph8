...
import com.puhua.framework.common.util.date.LocalDateTimeUtils;
import com.puhua.framework.common.util.number.MoneyUtils;
import com.puhua.framework.pay.core.client.PayClient;
import com.puhua.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.puhua.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/puhua-cloud/issues/I8SM9H 场景
