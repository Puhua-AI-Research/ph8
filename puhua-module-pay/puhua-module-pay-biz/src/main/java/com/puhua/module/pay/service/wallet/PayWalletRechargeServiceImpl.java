...
import com.puhua.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.puhua.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.puhua.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.puhua.module.pay.enums.ErrorCodeConstants.*;
import static com.puhua.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.puhua.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @普华：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
