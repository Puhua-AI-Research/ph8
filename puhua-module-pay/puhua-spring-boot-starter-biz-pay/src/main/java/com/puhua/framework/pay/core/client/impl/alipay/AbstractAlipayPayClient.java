package com.puhua.framework.pay.core.client.impl.alipay;
...
import com.puhua.framework.common.util.object.ObjectUtils;
...
import com.puhua.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import com.puhua.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import com.puhua.framework.pay.core.client.impl.AbstractPayClient;
import com.puhua.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import com.puhua.framework.pay.core.enums.transfer.PayTransferTypeEnum;
...
import static com.puhua.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
import static com.puhua.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_CERTIFICATE;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    protected PayTransferRespDTO doUnifiedTransfer(PayTransferUnifiedReqDTO reqDTO) throws AlipayApiException {
        ...
        switch (transferType) {
            ...
            // @普华。 是不是还要考虑转账到银行卡。所以传 transferType 但是转账到银行卡不知道要如何测试??
            case ALIPAY_BALANCE: {
