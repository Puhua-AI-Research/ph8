package com.puhua.module.mp.service.user;
...
import com.puhua.module.mp.dal.mysql.user.MpUserMapper;
...
public class MpUserServiceImpl implements MpUserService {
    ...
    private void updateUserTag(String appId, String openid, List<Long> tagIds) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.USER_UPDATE_TAG_FAIL, e.getError().getErrorMsg());
        }
    }
