...
import com.puhua.module.mp.convert.account.MpAccountConvert;
import com.puhua.module.mp.dal.dataobject.account.MpAccountDO;
import com.puhua.module.mp.dal.mysql.account.MpAccountMapper;
...
import static com.puhua.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.puhua.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 puhua-module-mp - 表结构未导入]");
            }
