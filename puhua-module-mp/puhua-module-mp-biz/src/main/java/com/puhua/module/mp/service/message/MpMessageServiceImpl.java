...
import com.puhua.module.mp.dal.mysql.message.MpMessageMapper;
import com.puhua.module.mp.enums.ErrorCodeConstants;
import com.puhua.module.mp.enums.message.MpMessageSendFromEnum;
...
public class MpMessageServiceImpl implements MpMessageService {
    ...
    public MpMessageDO sendKefuMessage(MpMessageSendReqVO sendReqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.MESSAGE_SEND_FAIL, e.getError().getErrorMsg());
        }
