package com.puhua.module.mp.service.material;
...
import com.puhua.module.mp.controller.admin.material.vo.MpMaterialUploadNewsImageReqVO;
import com.puhua.module.mp.controller.admin.material.vo.MpMaterialUploadPermanentReqVO;
import com.puhua.module.mp.controller.admin.material.vo.MpMaterialUploadTemporaryReqVO;
import com.puhua.module.mp.convert.material.MpMaterialConvert;
...
import com.puhua.module.mp.dal.mysql.material.MpMaterialMapper;
...
public class MpMaterialServiceImpl implements MpMaterialService {
    ...
    public MpMaterialDO uploadTemporaryMaterial(MpMaterialUploadTemporaryReqVO reqVO) throws IOException {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.MATERIAL_UPLOAD_FAIL, e.getError().getErrorMsg());
        } finally {
            FileUtil.del(file);
        }
    ...
    public String uploadNewsImage(MpMaterialUploadNewsImageReqVO reqVO) throws IOException {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.MATERIAL_IMAGE_UPLOAD_FAIL, e.getError().getErrorMsg());
        } finally {
            FileUtil.del(file);
        }
    }
    ...
    public void deleteMaterial(Long id) {
        ...
        if (material.getPermanent()) {
            ...
            try {
                ...
                throw exception(ErrorCodeConstants.MATERIAL_DELETE_FAIL, e.getError().getErrorMsg());
            }
        }
