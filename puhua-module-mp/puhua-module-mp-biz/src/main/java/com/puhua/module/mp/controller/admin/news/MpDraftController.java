package com.puhua.module.mp.controller.admin.news;

import cn.hutool.core.collection.CollUtil;
import com.puhua.framework.common.pojo.CommonResult;
import com.puhua.framework.common.pojo.PageResult;
import com.puhua.framework.common.util.collection.CollectionUtils;
import com.puhua.framework.common.util.object.PageUtils;
import com.puhua.module.mp.controller.admin.news.vo.MpDraftPageReqVO;
...
import com.puhua.module.mp.service.material.MpMaterialService;
...
public class MpDraftController {
    ...
    public CommonResult<PageResult<WxMpDraftItem>> getDraftPage(MpDraftPageReqVO reqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.DRAFT_LIST_FAIL, e.getError().getErrorMsg());
        }
    ...
    public CommonResult<String> deleteDraft(@RequestParam("accountId") Long accountId,
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.DRAFT_CREATE_FAIL, e.getError().getErrorMsg());
        }
    }
    ...
    public CommonResult<Boolean> deleteDraft(@RequestParam("accountId") Long accountId,
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.DRAFT_UPDATE_FAIL, e.getError().getErrorMsg());
        }
    }
    ...
    public CommonResult<Boolean> deleteDraft(@RequestParam("accountId") Long accountId,
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.DRAFT_DELETE_FAIL, e.getError().getErrorMsg());
        }
    }
