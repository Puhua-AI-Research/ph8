...
import com.puhua.module.mp.controller.admin.news.vo.MpFreePublishPageReqVO;
...
public class MpFreePublishController {
    ...
    public CommonResult<PageResult<WxMpFreePublishItem>> getFreePublishPage(MpFreePublishPageReqVO reqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.FREE_PUBLISH_LIST_FAIL, e.getError().getErrorMsg());
        }
    ...
    public CommonResult<String> submitFreePublish(@RequestParam("accountId") Long accountId,
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.FREE_PUBLISH_SUBMIT_FAIL, e.getError().getErrorMsg());
        }
    }
    ...
    public CommonResult<Boolean> deleteFreePublish(@RequestParam("accountId") Long accountId,
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.FREE_PUBLISH_DELETE_FAIL, e.getError().getErrorMsg());
        }
    }
