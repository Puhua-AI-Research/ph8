package com.puhua.module.mp.service.menu;
...
import com.puhua.module.mp.dal.mysql.menu.MpMenuMapper;
...
public class MpMenuServiceImpl implements MpMenuService {
    ...
    public void saveMenu(MpMenuSaveReqVO createReqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.MENU_SAVE_FAIL, e.getError().getErrorMsg());
        }
    ...
    public void deleteMenuByAccountId(Long accountId) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.MENU_DELETE_FAIL, e.getError().getErrorMsg());
        }
