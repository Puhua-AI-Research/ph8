package com.puhua.module.mp.service.tag;

import cn.hutool.core.collection.CollUtil;
import com.puhua.framework.common.pojo.PageResult;
import com.puhua.module.mp.controller.admin.tag.vo.MpTagCreateReqVO;
import com.puhua.module.mp.controller.admin.tag.vo.MpTagPageReqVO;
import com.puhua.module.mp.controller.admin.tag.vo.MpTagUpdateReqVO;
import com.puhua.module.mp.convert.tag.MpTagConvert;
import com.puhua.module.mp.dal.dataobject.account.MpAccountDO;
import com.puhua.module.mp.dal.dataobject.tag.MpTagDO;
import com.puhua.module.mp.dal.mysql.tag.MpTagMapper;
import com.puhua.module.mp.framework.mp.core.MpServiceFactory;
import com.puhua.module.mp.service.account.MpAccountService;
...
public class MpTagServiceImpl implements MpTagService {
    ...
    public Long createTag(MpTagCreateReqVO createReqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.TAG_CREATE_FAIL, e.getError().getErrorMsg());
        }
    ...
    public void updateTag(MpTagUpdateReqVO updateReqVO) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.TAG_UPDATE_FAIL, e.getError().getErrorMsg());
        }
    ...
    public void deleteTag(Long id) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.TAG_DELETE_FAIL, e.getError().getErrorMsg());
        }
    ...
    private MpTagDO validateTagExists(Long id) {
        ...
        if (tag == null) {
            throw exception(ErrorCodeConstants.TAG_NOT_EXISTS);
        }
        return tag;
    }
    ...
    public void syncTag(Long accountId) {
        ...
        try {
            ...
            throw exception(ErrorCodeConstants.TAG_GET_FAIL, e.getError().getErrorMsg());
        }
