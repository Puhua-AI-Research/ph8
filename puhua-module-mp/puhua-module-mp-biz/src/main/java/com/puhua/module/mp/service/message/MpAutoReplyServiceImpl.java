package com.puhua.module.mp.service.message;
...
import com.puhua.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyCreateReqVO;
import com.puhua.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyUpdateReqVO;
import com.puhua.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.puhua.module.mp.convert.message.MpAutoReplyConvert;
...
import com.puhua.module.mp.dal.mysql.message.MpAutoReplyMapper;
import com.puhua.module.mp.enums.ErrorCodeConstants;
import com.puhua.module.mp.enums.message.MpAutoReplyTypeEnum;
import com.puhua.module.mp.framework.mp.core.util.MpUtils;
import com.puhua.module.mp.service.account.MpAccountService;
import com.puhua.module.mp.service.message.bo.MpMessageSendOutReqBO;
...
public class MpAutoReplyServiceImpl implements MpAutoReplyService {
    ...
    private MpAutoReplyDO validateAutoReplyExists(Long id) {
        ...
        if (autoReply == null) {
            throw exception(ErrorCodeConstants.AUTO_REPLY_NOT_EXISTS);
        }
        return autoReply;
    }
