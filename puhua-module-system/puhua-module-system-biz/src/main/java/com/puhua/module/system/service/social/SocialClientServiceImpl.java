package com.puhua.module.system.service.social;
...
import com.puhua.framework.common.util.cache.CacheUtils;
import com.puhua.framework.common.util.http.HttpUtils;
import com.puhua.framework.common.util.object.BeanUtils;
import com.puhua.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.puhua.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.puhua.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.puhua.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.puhua.module.system.dal.dataobject.social.SocialClientDO;
import com.puhua.module.system.dal.mysql.social.SocialClientMapper;
import com.puhua.module.system.dal.redis.RedisKeyConstants;
...
import static com.puhua.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${puhua.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${puhua.wxa-subscribe-message.miniprogram-state:formal}")
