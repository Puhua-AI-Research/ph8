package com.puhua.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "中航普华")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "puhua")
    private String code;
