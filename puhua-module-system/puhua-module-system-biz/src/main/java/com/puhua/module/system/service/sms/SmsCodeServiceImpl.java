...
import com.puhua.module.system.dal.dataobject.sms.SmsCodeDO;
import com.puhua.module.system.dal.mysql.sms.SmsCodeMapper;
import com.puhua.module.system.enums.sms.SmsSceneEnum;
import com.puhua.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.puhua.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    @Override
    public void sendTemplateSmsCode(SmsTemplateCodeSendReqDTO reqDTO) {
        SmsSceneEnum sceneEnum = SmsSceneEnum.getCodeByScene(reqDTO.getScene());

        String code = createSmsCode(reqDTO.getMobile(), reqDTO.getScene(), reqDTO.getCreateIp());
        Map<String, Object> templateParams = reqDTO.getTemplateParams();
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 中航普华：提升，每个 IP 每天可发送数量
            // TODO 中航普华：提升，每个 IP 每小时可发送数量
        }
