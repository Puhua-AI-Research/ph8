package com.puhua.module.system.controller.admin.oauth2;
...
import com.puhua.framework.common.util.http.HttpUtils;
import com.puhua.framework.common.util.json.JsonUtils;
import com.puhua.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.puhua.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.puhua.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.puhua.module.system.convert.oauth2.OAuth2OpenConvert;
import com.puhua.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.puhua.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.puhua.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.puhua.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.puhua.module.system.service.oauth2.OAuth2ApproveService;
import com.puhua.module.system.service.oauth2.OAuth2ClientService;
import com.puhua.module.system.service.oauth2.OAuth2GrantService;
import com.puhua.module.system.service.oauth2.OAuth2TokenService;
import com.puhua.module.system.util.oauth2.OAuth2Utils;
...
import static com.puhua.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.puhua.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://ph8.co"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://ph8.co"),
