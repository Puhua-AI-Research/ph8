package com.puhua.module.system.controller.admin.user.vo.profile;

import com.puhua.module.system.controller.admin.dept.vo.dept.DeptSimpleRespVO;
import com.puhua.module.system.controller.admin.dept.vo.post.PostSimpleRespVO;
import com.puhua.module.system.controller.admin.permission.vo.role.RoleSimpleRespVO;
...
public class UserProfileRespVO {
    ...
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "中航普华")
    private String nickname;

    @Schema(description = "用户邮箱", example = "puhua@ph8.co")
    ...
    @Schema(description = "用户头像", example = "https://ph8.co/xxx.png")
