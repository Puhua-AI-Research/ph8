...
import com.puhua.framework.tenant.config.TenantProperties;
...
import com.puhua.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import com.puhua.module.system.convert.tenant.TenantConvert;
import com.puhua.module.system.dal.dataobject.permission.MenuDO;
...
import com.puhua.module.system.dal.mysql.tenant.TenantMapper;
import com.puhua.module.system.enums.permission.RoleCodeEnum;
import com.puhua.module.system.enums.permission.RoleTypeEnum;
import com.puhua.module.system.service.permission.MenuService;
...
import com.puhua.module.system.service.tenant.handler.TenantInfoHandler;
import com.puhua.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 puhua.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
