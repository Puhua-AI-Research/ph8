...
import com.puhua.module.system.controller.admin.user.vo.user.*;
...
import com.puhua.module.system.enums.common.SexEnum;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("api").deptId(1L).email("api@ph8.co").mobile("15601691300")
                        .nickname("中航普华").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("api").deptId(2L).email("api@ph8.co").mobile("15601701300")
